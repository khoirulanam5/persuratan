                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('pegawai/arsip/add') ?>" class="btn btn-sm btn-primary">Arsipkan Surat</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($arsip as $val): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('pegawai/arsip/detail/') . $val->id_arsip ?>" class="btn btn-primary btn-sm">Detail</a>
                                                        <a href="<?= base_url('pegawai/arsip/delete/') . $val->id_arsip ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
