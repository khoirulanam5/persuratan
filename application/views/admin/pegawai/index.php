                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('admin/pegawai/add') ?>" class="btn btn-sm btn-primary">Tambah Data</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($pegawai as $val): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $val->no_hp ?></td>
                                                    <td>
                                                        <a href="<?= base_url('admin/pegawai/edit/') . $val->id_user ?>" class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="<?= base_url('admin/pegawai/delete/') . $val->id_user ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
