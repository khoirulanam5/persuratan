                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('admin/prosessurat/add') ?>" class="btn btn-sm btn-primary">Kirim Surat</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($surat as $val): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admin/prosessurat/edit/') . $val->id_surat_keluar ?>" class="btn btn-success btn-sm">Edit</a>
                                                        <a href="<?= base_url('admin/prosessurat/cetak/') . $val->id_surat_keluar ?>" target="_blank" class="btn btn-primary btn-sm">Cetak</a>
                                                        <a href="<?= base_url('admin/prosessurat/delete/') . $val->id_surat_keluar ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
