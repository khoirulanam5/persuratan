                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('tamu/kirimsurat/add') ?>" class="btn btn-sm btn-primary">Kirim Surat</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($surat as $val): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($val->status === NULL): ?>
                                                        <a href="<?= base_url('tamu/kirimsurat/edit/') . $val->id_surat_masuk ?>" class="btn btn-primary btn-sm">Edit</a>
                                                        <?php endif; ?>
                                                        <a href="<?= base_url('tamu/kirimsurat/delete/') . $val->id_surat_masuk ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
