...
<body class="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php elseif ($val->status === 'Teruskan'): ?>
                                                            <a href="<?= base_url('tamu/suratterima/update_status/' . $val->id_surat_keluar) ?>" class="badge badge-warning terima">Terima surat</a>
                                                        <?php elseif ($val->status === 'Diterima'): ?>
                                                            <span class="badge badge-success">Diterima</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <a href="<?= base_url('tamu/suratterima/cetak/') . $val->id_surat_keluar ?>" target="_blank" class="btn btn-primary btn-sm">Cetak</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        ...
        item.addEventListener('click', function(e) {
            ...
            Swal.fire({
                title: "Terima Surat?",
                text: "Konfirmasi penerimaan surat dari pegawai!",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
